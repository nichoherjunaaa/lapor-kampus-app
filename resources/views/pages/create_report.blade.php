    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="glass-card rounded-2xl p-6 md:p-8 text-center">
                <div class="mb-6">
                    <div
                        class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-green-100 to-teal-100 rounded-2xl mb-4">
            ...
            <div id="step1" class="fade-in">
                <div class="glass-card rounded-2xl p-6 md:p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="category-card glass-card rounded-xl p-6 border-2 border-transparent"
                            onclick="selectCategory('fasilitas')">
                        ...
                        <div class="category-card glass-card rounded-xl p-6 border-2 border-transparent"
                            onclick="selectCategory('akademik')">
                            <div class="text-center">
                        ...
                        <div class="category-card glass-card rounded-xl p-6 border-2 border-transparent"
                            onclick="selectCategory('keamanan')">
                            <div class="text-center">
                        ...
                        <div class="category-card glass-card rounded-xl p-6 border-2 border-transparent"
                            onclick="selectCategory('kebersihan')">
                            <div class="text-center">
                        ...
                        <div class="category-card glass-card rounded-xl p-6 border-2 border-transparent"
                            onclick="selectCategory('lainnya')">
                            <div class="text-center">
                    ...
                    <div class="mt-8 text-center">
                        <button type="button" onclick="nextStep()"
                            class="bg-gradient-to-r from-green-500 to-teal-600 text-white px-8 py-3 rounded-xl font-semibold hover:from-green-600 hover:to-teal-700 transform hover:scale-105 transition-all duration-300"
                            disabled id="nextBtn1">
                            Lanjutkan
                ...
                <div class="space-y-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text"
                                    ...
                                    placeholder="Contoh: AC Ruang Kelas 3A Tidak Berfungsi" id="reportTitle" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text"
                                    class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white/80"
                                    placeholder="Contoh: Gedung A, Lantai 3, Ruang Kelas 3A" id="reportLocation"
                                    required>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div class="priority-option border-2 border-gray-200 rounded-xl p-4 text-center"
                                    ...
                                    <div class="priority-option border-2 border-gray-200 rounded-xl p-4 text-center"
                                        ...
                                        <div
                                            class="w-8 h-8 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-2">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    id="reportDescription" required></textarea>
                    ...
                    <div class="glass-card rounded-2xl p-6 md:p-8">
                        ...
                        <div class="drag-area rounded-xl p-8 text-center" id="dragArea">
                            ...
                            <p class="text-xs text-gray-500 mt-4">Format: JPG, PNG, JPEG | Maksimal 5MB per file |
                                Maksimal 3 foto</p>
                        </div>
                ...
                <div class="glass-card rounded-2xl p-6 md:p-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                            <div class="flex items-start">
                                ...
                                <label for="agreement" class="text-sm text-blue-800">
                                    ...
                                    dipertanggungjawabkan. Saya memahami bahwa laporan palsu dapat dikenakan sanksi.
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-between">
                            ...
                            <button type="submit"
                                class="bg-gradient-to-r from-green-500 to-teal-600 text-white px-8 py-3 rounded-xl font-semibold hover:from-green-600 hover:to-teal-700 transform hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <div class="glass-card rounded-2xl p-8 max-w-md w-full mx-4">
            <div class="text-center">
                ...
                <button onclick="closeModal()"
                    class="bg-gradient-to-r from-green-500 to-teal-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-green-600 hover:to-teal-700 transition-all duration-300">
                    Tutup
                </button>
            </div>
        </div>
