...
<body class="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-teal-50 relative">
    ...
    <nav class="relative z-10 bg-white/80 backdrop-blur-lg border-b border-white/20 sticky top-0">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex space-x-2">
                    <a href="#" onclick="setActiveNav('home')" class="nav-item active px-4 py-2 rounded-lg font-medium" id="nav-home">
                        <i class="fas fa-home mr-2"></i>
                        Home
                    </a>
                    <a href="#" onclick="setActiveNav('lapor')" class="nav-item px-4 py-2 rounded-lg font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-100" id="nav-lapor">
        ...
        <div class="md:hidden px-4 pb-3">
            <div class="flex space-x-1">
                <a href="#" onclick="setActiveNav('home')" class="nav-item active flex-1 text-center py-2 rounded-lg font-medium text-sm" id="nav-home-mobile">
                    <i class="fas fa-home"></i>
                    <span class="block text-xs mt-1">Home</span>
                </a>
                <a href="#" onclick="setActiveNav('lapor')" class="nav-item flex-1 text-center py-2 rounded-lg font-medium text-sm text-gray-600" id="nav-lapor-mobile">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="glass-card rounded-3xl p-8 card-hover">
                <div class="text-center">
                    <div class="mb-6">
                        <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-green-100 to-teal-100 rounded-3xl mb-4">
                    ...
                    <p class="text-lg text-gray-600 mb-6 max-w-2xl mx-auto">
                        Platform digital yang memfasilitasi mahasiswa untuk melaporkan berbagai keluhan kampus secara transparan dan terorganisir
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <button onclick="setActiveNav('lapor')" class="bg-gradient-to-r from-green-500 to-teal-600 text-white px-8 py-3 rounded-xl font-semibold hover:from-green-600 hover:to-teal-700 transform hover:scale-105 transition-all duration-300 flex items-center justify-center">
                            <i class="fas fa-plus mr-2"></i>
                            Buat Laporan Baru
                        </button>
                        <button onclick="setActiveNav('daftar')" class="bg-white/70 text-gray-700 px-8 py-3 rounded-xl font-semibold hover:bg-white/90 border border-gray-200 transform hover:scale-105 transition-all duration-300 flex items-center justify-center">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="glass-card rounded-2xl p-6 card-hover text-center">
                    <div class="w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl mx-auto mb-4 flex items-center justify-center">
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8 mb-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="#" onclick="setActiveNav('daftar')" class="text-green-600 hover:text-green-700 font-medium flex items-center">
            ...
            <div class="space-y-4">
                <div class="flex items-start space-x-4 p-4 bg-white/60 rounded-xl border border-white/20">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Laporan mengenai AC yang rusak di lantai 3 gedung utama telah ditindaklanjuti dan diperbaiki</p>
                ...
                <div class="flex items-start space-x-4 p-4 bg-white/60 rounded-xl border border-white/20">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Berdasarkan laporan mahasiswa, bandwidth WiFi kampus akan ditingkatkan minggu depan</p>
                ...
                <div class="flex items-start space-x-4 p-4 bg-white/60 rounded-xl border border-white/20">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Tim kebersihan akan melakukan pembersihan menyeluruh toilet umum setiap 2 jam</p>
    ...
    <script>
        function setActiveNav(page) {
            ...
            if (page === 'lapor') {
                window.location.href = 'laporan-create.html';
            } else if (page === 'daftar') {
