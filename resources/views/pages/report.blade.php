    ...
    <nav class="relative z-10 bg-white/80 backdrop-blur-lg border-b border-white/20 sticky top-0">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex space-x-2">
                    ...
                    <a href="#" onclick="setActiveNav('daftar')" class="nav-item active px-4 py-2 rounded-lg font-medium" id="nav-daftar">
        ...
        <div class="md:hidden px-4 pb-3">
            <div class="flex space-x-1">
                ...
                <a href="#" onclick="setActiveNav('daftar')" class="nav-item active flex-1 text-center py-2 rounded-lg font-medium text-sm" id="nav-daftar-mobile">
